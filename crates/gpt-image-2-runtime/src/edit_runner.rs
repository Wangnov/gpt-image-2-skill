...
use gpt_image_2_core::{
    EditRequest, batch_output_path, batch_recovery_job_dir, batch_recovery_job_id,
    edit_args_with_recovery, generation_slots_from_batch_payload, output_extension, requested_n,
...
pub fn edit_region_mode_for_request(
    request: &EditRequest,
    provider_edit_region_mode: impl FnOnce(Option<&str>) -> String,
) -> String {
...
pub fn write_edit_inputs_with_region_mode(
    request: &EditRequest,
    dir: &Path,
    edit_region_mode: &str,
    ...
    Ok((ref_paths, mask_path, edit_region_mode.to_string()))
}

pub fn edit_request_metadata_with_region_mode(
    request: &EditRequest,
    edit_region_mode: &str,
) -> Value {
    json!({
...
pub fn run_edit_request(
    ...
    let request_meta = edit_request_metadata_with_region_mode(&request, &edit_region_mode);
