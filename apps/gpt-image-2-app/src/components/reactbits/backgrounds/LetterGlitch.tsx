// Adapted from reactbits.dev (DavidHDev/react-bits) — Backgrounds/LetterGlitch
// Vendored verbatim except: every prop is now optional with a default,
// so callers (theme presets) can supply only the fields they care about.
