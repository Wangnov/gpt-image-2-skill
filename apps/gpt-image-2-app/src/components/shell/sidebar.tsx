...
export function Sidebar({
  ...
  const defaultProv = config?.default_provider ? config.providers[config.default_provider] : undefined;

  return (
    <div
      className="w-[232px] shrink-0 flex flex-col bg-sunken border-r border-border"
    >
      <div className="h-11 px-3.5 flex items-center gap-3">
        {/* Traffic lights rendered from App if needed; keep spacing */}
